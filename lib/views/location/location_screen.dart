...
class _LocationScreenState extends State<LocationScreen>
  ...
  Future<void> _handleCurrentLocation() async {
    ...
    try {
      ...
      final success = await locationProvider.getCurrentLocationAndAdd();

      if (mounted) {
        if (locationProvider.errorMessage != null) {
          _showSnackBar(locationProvider.errorMessage!, isError: true);
        } else if (success && locationProvider.currentPosition != null) {
          _showSnackBar('Current location detected and saved successfully!');
  ...
  Future<void> _handleLocationSelection(Prediction prediction) async {
    ...
    try {
      ...
      if (mounted) {
        ...
        // Add location to backend using the service
        ...
        if (success) {
          ...
          _showSnackBar(
            locationProvider.errorMessage ?? 'Failed to update location',
            isError: true,
          );
        }
      }
  ...
  Widget build(BuildContext context) {
    print('userrrrrrrrrrrrrrrrridddddddddddddddddddd ${widget.userId}');
