...
class _ForgotPasswordState extends State<ForgotPassword> {
  ...
  Future<void> _handleResetPassword() async {
    if (_formKey.currentState!.validate()) {
      ...
      bool success = await provider.forgotPassword(
        ...
        if (success) {
          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              ...
              content: Text(
                provider.response?.message ?? 'Password reset successfully',
              ),
              actions: [
                TextButton(
                  onPressed: () {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(provider.errorMessage ?? 'Failed to reset password'),
